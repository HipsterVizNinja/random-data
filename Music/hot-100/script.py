...
df_all = pd.read_csv('/Users/sm029588/OneDrive - Cerner Corporation/VSCode/Billboard-Hot-100/Hot 100.csv', usecols=['chart_position', 'song', 'performer', 'song_id', 'chart_date'], parse_dates=['chart_date'])
...
# Output
df_all.to_csv('/Users/sm029588/OneDrive - Cerner Corporation/VSCode/Billboard-Hot-100/Hot 100.csv', index=False, columns=['chart_position', 'chart_date', 'song', 'performer', 'song_id','instance', 'time_on_chart', 'consecutive_weeks', 'previous_week', 'peak_position', 'worst_position', 'chart_debut', 'chart_url'])
print()